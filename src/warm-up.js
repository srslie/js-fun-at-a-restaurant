...
//I think you mean inStock so that's the variable I'm doing :)
if (inStock >= 1) {
...
var vegetables = ['carrot', 'onion', 'celery', 'bell pepper', 'lettuce']
...
// different fruits.
var fruits = ['banana', 'apple', 'mango', 'grape', 'kiwi', 'tomato', 'olive']
